...
htmlhelp_basename = 'pybel-admindoc'
...
latex_documents = [
    (master_doc, 'pybel-admin.tex', 'pybel-admin Documentation',
...
man_pages = [
    (master_doc, 'pybel-admin', 'pybel-admin Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pybel-admin', 'pybel-admin Documentation',
     author, 'pybel-admin', 'One line description of project.',
     'Miscellaneous'),
]
